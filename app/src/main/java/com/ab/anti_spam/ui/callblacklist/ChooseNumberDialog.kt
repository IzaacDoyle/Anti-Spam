...
import com.ab.anti_spam.databinding.FragmentChooseNumberDialogBinding
import com.ab.anti_spam.models.ChooseNumberModel
import java.text.SimpleDateFormat
import java.util.*


class ChooseNumberDialog : DialogFragment(), chooseNumberListener {

    private var _fragBinding: FragmentChooseNumberDialogBinding? = null
    ...
    override fun onCreateView(
        ...
        _fragBinding = FragmentChooseNumberDialogBinding.inflate(inflater, container, false)
